...
if (isset($_GET["onglet"])) {
	...
	//NAV HAUT
	require_once('includes/nav_haut.php');
...
<!-- Systeme de notes -->
			...
			while($cpt < $i){
				...
				$description_url = "description_".$_SESSION['genre'].".php?id_artiste=".$_SESSION['id_artiste']."&id_oeuvre=".$_SESSION['fiche_artiste'][$cpt]['id_oeuvre'];

				echo "<a href='$description_url'><img src='$url' width='300px' height='200px'/></a>
						<br /><br /><br />"; 
			$cpt++;
			}
	break;
